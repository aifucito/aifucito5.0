...
/* ==========================================
    🧪 DEBUG: OBTENER CHAT ID
========================================== */
bot.on("message", (ctx, next) => {
  console.log("📡 CHAT ID DETECTADO:", ctx.chat.id, "| Tipo:", ctx.chat.type);
  return next();
});
