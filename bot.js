...
/* =========================
   ALMACENAMIENTO
   (Render usa /data para persistencia)
========================= */
...
Puedes reportar avistamientos y aparecerán en el radar.`,
    menuPrincipal()
  )
...
['❌ Cancelar']
  ...
  if (ctx.message.photo && s.paso === "fotos") {
    ...
    return ctx.reply("Foto agregada al reporte.")
...
${datos.descripcion}`
  ...
  try {
    ...
    ctx.reply(
"Reporte enviado correctamente al radar.",
menuPrincipal()
    )
